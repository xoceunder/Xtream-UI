...
rDownloadURL = {"main": "https://github.com/xoceunder/Xtream-UI/raw/master/main.zip", "sub": "https://github.com/xoceunder/Xtream-UI/raw/master/sub.zip"}
rPackages = ["libcurl3", "libgeoip-dev", "libxslt1-dev", "e2fsprogs", "wget", "mcrypt", "nscd", "htop", "mysql-server", "unzip"]
