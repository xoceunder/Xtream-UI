...
def autoupdate():
    ...
    os.system('chattr -i /home/xtreamcodes/iptv_xtream_codes/GeoLite2.mmdb && wget "https://github.com/xoceunder/Xtream-UI/raw/master/update.zip" -O /tmp/update.zip -o /dev/null && unzip /tmp/update.zip -d /tmp/update/ >/dev/null && cp -rf /tmp/update/XtreamUI-master/* /home/xtreamcodes/iptv_xtream_codes/ 2>/dev/null && rm -rf /tmp/update/XtreamUI-master && rm /tmp/update.zip && rm -rf /tmp/update && wget http://xtream-ui.mine.nu/GeoLite2/GeoLite2.mmdb -O /home/xtreamcodes/iptv_xtream_codes/GeoLite2.mmdb -o /dev/null && chown -R xtreamcodes:xtreamcodes /home/xtreamcodes && find /home/xtreamcodes/ -type d -not \( -name .update -prune \) -exec chmod -R 777 {} + && chattr +i /home/xtreamcodes/iptv_xtream_codes/GeoLite2.mmdb && rm /usr/bin/ffmpeg 2>/dev/null && rm /usr/bin/ffprobe 2>/dev/null && ln -s /home/xtreamcodes/iptv_xtream_codes/bin/ffmpeg /usr/bin/')
